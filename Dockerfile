...
LABEL maintainer="Bjoern Kimminich <bjoern.kimminich@owasp.org>" \
    ...
    org.opencontainers.image.version="12.4.0" \
...
COPY contrast_security.$CONTRAST_CONFIG.yml ./contrast_security.yml
RUN mkdir logs && \
    chown -R juicer logs && \
